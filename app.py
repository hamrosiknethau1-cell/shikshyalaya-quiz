...
st.markdown(
    """
    <style>
    /* मुख्य ब्याकग्राउन्ड रङ */
    .stApp {
        background-color: #f4f7f6 !important;
    }
    
    /* पछाडि पट्टि देखिने हल्का वाटरमार्क */
    .stApp::before {
...
# ६. पूर्ण १०-१० वटा प्रश्नहरूको परिमार्जित डाटाबेस (उत्तरहरू फरक-फरक ठाउँमा राखिएका छन्)
quiz_data = {
    "नेपालको संविधान": [
        ...
        {"q": "६. नेपालको संविधान संसोधन सम्बन्धी व्यवस्था कुन भागमा गरिएको छ?", "options": ["भाग २७", "भाग २८", "भाग २९"], "ans": "भाग २7", "hint": "यो भागमा संविधान संसोधनको प्रक्रिया र सीमाहरू तोकिएका छन्।"},
    ...
    "मुलुकी देवानी संहिता": [
        {"q": "१. मुलुकी देवानी संहिता, २०७४ कहिलेदेखि लागू भयो?", "options": ["२०७४ भदौ १ गते", "२०७५ असोज १ गते", "२०७५ भदौ १ गते"], "ans": "२०७५ भदौ १ gते", "hint": "यो कानुन पुरानो मुलुकी ऐन, २०२० लाई प्रतिस्थापन गर्दै लागू भएको हो।"},
...
if topic == "गृहपृष्ठ (Home)":
    ...
    st.info("💡 विशेषता: भिडियो बनाउन सजिलो होस् भनेर यहाँ उत्तर जाँचेको ३ सेकेन्डपछि आफैँ अर्को प्रश्न आउनेछ।")
    ...
    if current_idx >= len(questions):
        ...
        if not st.session_state["answered"]:
            if st.button("✔️ उत्तर जाँच्नुहोस्"):
                ...
                # ३ सेकेन्ड पर्खने र आफैँ अर्को प्रश्न लोड गर्ने (स्वचालित प्रक्रिया)
                time.sleep(3)

...
# --- १. आकर्षक कलर थीम र वाटरमार्कका लागि CSS कोड (डिजाइन परिवर्तन) ---
st.markdown(
    """
    <style>
    ...
    .stApp::before {
        ...
        font-size: 5rem;
        font-weight: bold;
        color: rgba(0, 51, 102, 0.04); /* एकदमै हल्का निलो रङको वाटरमार्क */
        z-index: 0;
        pointer-events: none;
        white-space: nowrap;
        text-align: center;
    ...
    /* हेडलाइन र शीर्षकहरू रङ्गीन बनाउने */
    h1 {
    ...
    /* रेडियो बटन (Options) को बाकस रङ्गीन र आकर्षक बनाउने */
    ...
    /* उत्तर जाँच्ने र अर्को प्रश्नका बटनहरूलाई कलरफुल बनाउने */
    div.stButton > button {
    ...
    /* देब्रेपट्टीको मेनु बार (Sidebar) रङ्गीन बनाउने */
...
# २. पासवर्ड सुरक्षा (Password: nepal123)
...
# ३. प्रश्नहरू ट्र्याक गर्न सेसन स्टेट (Session State) मिलाउने
...
# प्रश्नहरूको डाटाबेस (१०-१० वटा प्रश्नहरू)
quiz_data = {
    "नेपालको संविधान": [
        ...
        {"q": "३. नेपालको संविधानमा कति भाग, धारा र अनुसूचीहरू छन्?", "options": ["३५ भाग, ३०८ धारा, ९ अनुसूची", "३५ भाग, धारा ३१५, धारा ८ अनुसूची", "३० भाग, ३०० धारा, ७ अनुसूची"], "ans": "३५ भाग, ३0८ धारा, ९ अनुसूची", "hint": "पहिलो जारी हुँदा र हालसम्म यो संरचना परिवर्तन भएको छैन।"},
        ...
        {"q": "८. संबैधानिक निकाय 'अख्तियार दुरुपयोग अनुसन्धान आयोग' सम्बन्धी व्यवस्था कुन भागमा छ?", "options": ["भाग २१", "भाग २२", "भाग २३"], "ans": "भाग २1", "hint": "यो भ्रष्टाचार नियन्त्रण गर्ने नेपालको प्रमुख संवैधानिक निकाय हो।"},
    ...
    "मुलुकी देवानी संहिता": [
        ...
        {"q": "४. देवानी संहिता अनुसार कति वर्षसम्म कतै जानकारी नभएमा व्यक्तिको प्राकृतिक मृत्यु भएको मानिन्छ (हराएको हकमा)?", "options": ["१२ वर्ष", "१० वर्ष", "७ वर्ष"], "ans": "१२ वर्ष", "hint": "लामो समयसम्म फेला नपरेका व्यक्तिको सम्पत्ति र हक हस्तान्तरणका लागि यो कानुनी अवधि तोकिएको हो।"},
        ...
        {"q": "८. अंशियारहरूका बीच सम्पत्ति अंशबण्डा गर्दा कुन आधारमा गरिन्छ?", "options": ["समान आधारमा", "जेठो छोराको इच्छामा", "कमाउने व्यक्तिको हकमा"], "ans": "समान आधारमा", "hint": "देवानी संहिताले लैंगिक वा जन्मक्रमका आधारमा भेदभाव नगरी बराबरी हक दिन्छ।"},
        {"q": "९. हकसाफी (Pre-emption) सम्बन्धी दाबी गर्ने हदम्याद कति तोकिएको छ?", "options": ["६ महिना", "३ महिना", "३५ दिन"], "ans": "६ महिना", "hint": "सम्पत्ति बिक्री भएको थाहा पाएको मितिबाट निश्चित महिनाभित्र अदालत जानुपर्छ।"},
...
if topic == "गृहपृष्ठ (Home)":
    ...
    st.write("देब्रेपट्टिको रङ्गीन मेनुबाट आफूले खेल्न चाहेको कानुन वा विषय छनोट गर्नुहोस् र आफ्नो तयारीलाई मजबुत बनाउनुहोस्।")
    st.info("💡 विशेषता: यहाँ एक पटकमा एउटा मात्र प्रश्न आकर्षक रूपमा आउनेछ।")
    ...
    if current_idx >= len(questions):
        st.balloons()
        st.success("🎉 बधाई छ! तपाईंले यो विधाका सबै प्रश्नहरू पूरा गर्नुभयो।")

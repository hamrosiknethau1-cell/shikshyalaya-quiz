...
# १. प्रश्नहरू र स्कोर ट्र्याक गर्न सेसन स्टेट (Session State)
...
# २. साधारण र सुरक्षित लगइन विन्डो (अक्षर लुक्ने समस्या नहुने गरी)
if not st.session_state["authenticated"]:
    st.title("🔒 शिक्षालय अनलाइन क्विज हब")
    st.subheader("कृपया अगाडि बढ्न पासवर्ड राख्नुहोस्")
    st.write("---")
    
    password = st.text_input("भिडियो बनाउने मुख्य पासवर्ड:", type="password")
...
st.markdown(
    """
    <style>
    /* मुख्य ब्याkग्राउन्ड रङ */
    .stApp {
        background-color: #f4f7f6 !important;
    }
    
    /* पछाडि पट्टि देखिने हल्का वाटरमार्क (Text को पछाडि बस्ने गरी - z-index: -1) */
    .stApp::before {
        ...
        z-index: -1;  /* यसले गर्दा अक्षरहरू लुक्दैनन् */
        pointer-events: none;
        white-space: nowrap;
    }

    /* शीर्षक र प्रश्नहरूको आकर्षक रङ */
    h1 { color: #1e3c72 !important; font-weight: 800 !important; }
    h2, h3 { color: #2a5298 !important; font-weight: bold !important; }
    
    /* प्रश्न र विकल्पहरूको अक्षर प्रस्ट बनाउने */
...
# ६. पूर्ण १०-१० वटा प्रश्नहरूको डाटाबेस
quiz_data = {
    "नेपालको संविधान": [
        ...
        {"q": "४. नेपालको संविधानको कुन धारामा 'समानताको हक' व्यवस्था गरिएको छ?", "options": ["धारा १८", "धारा १६", "धारा १७"], "ans": "धारा १८", "hint": "यो हक मौलिक हक अन्तर्गत पर्दछ।"},
        {"q": "५. संविधान अनुसार नेपालको सार्वभौमसत्ता र राजकीयसत्ता कसमा निहित रहेको छ?", "options": ["नेपाली जनतामा", "राष्ट्रपतिमा", "s संसदमा"], "ans": "नेपाली जनतामा", "hint": "धारा २ मा यसको स्पष्ट व्याख्या गरिएको छ।"},
    ...
    "मुलुकी देवानी संहिता": [
        {"q": "१. मुलुकी देवानी संहिता, २०७४ कहिलेदेखि लागू भयो?", "options": ["२०७५ भदौ १ गते", "२०७४ भदौ १ गते", "२०७५ असोज १ गते"], "ans": "२०७५ भभदौ १ गते", "hint": "यो कानुन पुरानो मुलुकी ऐन, २०२० लाई प्रतिस्थापन गर्दै लागू भएको हो।"},
...
if topic == "गृहपृष्ठ (Home)":
    ...
    st.write("देब्रेपट्टिको मेनु बारबाट आफूले खेल्न चाहेको कानुन वा विषय छनोट गर्नुहोस् र आफ्नो तयारीलाई मजबुत बनाउनुहोस्।")
    st.info("💡 विशेषता: भिडियो बनाउन सजिलो होस् भनेर यहाँ एक पटकमा एउटा मात्र प्रश्न आकर्षक रूपमा आउनेछ।")

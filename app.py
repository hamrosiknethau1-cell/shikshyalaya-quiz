...
if st.session_state["user_role"] == "admin":
    st.write("🟢 **भूमिका:** एडमिन मोड (३ सेकेन्ड अटो नेक्स्ट र टाइमर)")
else:
    st.write("🔵 **भूमिका:** परीक्षार्थी मोड (३ सेकेन्ड अटो नेक्स्ट र लाइभ टाइमर)")
st.markdown("---")
...
quiz_data = {
    "नेपालको संविधान": [
        ...
        {"q": "८. संबैधानिक निकाय 'अख्तियार दुरुपयोग अनुसन्धान आयोग' सम्बन्धी व्यवस्था कुन भागमा छ?", "options": ["भाग २२", "भाग २३", "भाग २1"], "ans": "भाग २१", "hint": "यो भ्रष्टाचार नियन्त्रण गर्ने नेपालको प्रमुख संवैधानिक निकाय हो।"},
    ...
    "सैनिक ऐन, २०६३": [
        ...
        {"q": "५. सैनिक ऐन अनुसार adenसेनापतिको पदावधि कति वर्षको हुनेछ?", "options": ["३ वर्ष", "४ वर्ष", "५ वर्ष"], "ans": "३ वर्ष", "hint": "धारा १४ अनुसार प्रधानसेनापति आफ्नो पदमा निश्चित अवधिसम्म मात्र रहन पाउँछन्।"},
...
if topic == "गृहपृष्ठ (Home)":
    ...
    st.write("देब्रेपट्टिको मेनु बारबाट आफू अनुकूलको विषय रोज्नुहोस्।")
    st.info("📊 **मुख्य अपडेट:** अब परीक्षार्थीले उत्तर जाँचेको ठीक **३ सेकेन्डपछि** प्रणाली स्वचालित रूपमा (Auto-Next) अर्को प्रश्नमा जानेछ र अन्त्यमा पूर्ण मार्कसिट देखिनेछ।")
    ...
    if current_idx >= len(questions):
        ...
        # प्रतिशत र उत्तीर्ण/अनुत्तीर्ण नतिजा (४०% उत्तीर्णाङ्क)
        ...
        if not st.session_state["answered"]:
            if st.button("✔️ उत्तर जाँच्नुहोस्"):
                ...
                # --- [सुधारिएको ३ सेकेन्ड अटो-नेक्स्ट काउन्टडाउन] ---
            ...
            # सुरक्षित स्टेट ब्याकअप डिस्प्ले (यदि पेज कुनै कारणले रोकिएमा)
            if user_choice == q_item["ans"]:
                st.success("🎉 सही उत्तर!")
            else:
                st.error(f"❌ गलत उत्तर! सही उत्तर: **{q_item['ans']}** हो।")
